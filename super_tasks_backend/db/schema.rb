...
ActiveRecord::Schema[7.1].define(version: 2025_08_12_195353) do
  ...
  create_table "training_logs", force: :cascade do |t|
    ...
    t.index ["performed_at"], name: "index_training_logs_on_performed_at"
  ...
  add_foreign_key "study_goals", "users"
